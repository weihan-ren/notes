...
| **rLLM** | UC Berkeley | 不改 Agent 代码做 RL 训练，5.7K⭐ | [🔍](javascript:searchKB('rLLM Agent RL')) |
...
| **smolagents** | HuggingFace | Code-as-Action，核心<1K 行，28K⭐ | [🔍](javascript:searchKB('smolagents CodeAgent')) |
| **CrewAI** | CrewAI Inc | 角色扮演多 Agent 编排，54K⭐ | [🔍](javascript:searchKB('CrewAI Flows')) |
| **OpenAI Agents SDK** | OpenAI | Handoffs + Guardrails + Sandbox，27K⭐ | [🔍](javascript:searchKB('OpenAI Agents SDK')) |
...
| **GSPO/SAPO** | Group/Soft Adaptive Policy Optimization | GSPO 序列级裁剪，SAPO 软门控+非对称温度（阿里 Qwen） | [🔍](javascript:searchKB('GSPO SAPO')) |
